            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <div>
                                ...
                                <div class="privacy-content">We take your privacy extremely seriously.
                                    All data will be collected, stored and used by us in accordance with
                                    the European Union General Data Protection Regulation No. 2016/679
                                </div>
                                <div class="privacy-content">The services offered by us via the Website and/or App
                                    (jointly "Platform") can function only if we collect, store, transfer, delete and/or otherwise use ("collect and use")
                                    specific data relating to you. Personal data means all information relating to an identified or
                        ...
                        <div class="accordion-body">
                            <div>
                                ...
                                <div class="privacy-content">Most of your personal data are required to perform
                                    a contract (GTC) with you. In case you do not provide us with this personal data, we will not be able to
                                    conclude and execute a contract (GTC) with you. Part of your data are required to
                                    fulfill our legal obligations when you are a member of our Platform. In case you do
                            ...
                            <div class="privacy-content">
                                <ol class="" style="list-style-type: upper-roman;">
                                    <li>User name (necessary when you register a new account);</li>
                                    <li>IC number;</li>
                                    <li>Email;</li>
                                    <li>Address;</li>
                                    <li>Password (necessary when you register a new account);</li>
                                </ol>
                            </div>
                            <div class="privacy-sub-header">
                                2.3 To enable notifications for you
                            </div>
                            <div class="privacy-content">When you are a registered member on the Platform, we will provide you 
                                with notifications regarding your new followers, your favorite items, your activity on the forum 
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <div class="privacy-content">Vinted transfers or shares personal
                                ...
                                as a result, receive personal data as recipients of data.
                            </div>
                            <div class="privacy-content">We constantly conduct and
                                improve technical maintenance of the Platform to protect the security and confidentiality
                                of personal data we process and to perform certain business-related functions that help make
                                our services available and functional. For this reason, we transfer your profile data to service
                                providers which provide cloud and hosting services, IT security, maintenance and technical services,  
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <div class="privacy-content">As we are constantly
                                developing our services, we reserve the right to change this Privacy Policy at any time
                                subject to the applicable regulations. Any changes will be published promptly on this page.
                                Regardless of the aforementioned, you should check this page regularly for any updates.
                            </div>
                        </div>
                        <div>
                        </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingFive">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFive" aria-expanded="false" aria-controls="flush-collapseFive">
                            5. What is My Right to Know about my personal data collected, disclosed, or transferred?
                        </button>
                    </h2>
                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <div class="privacy-content">You have the right to request that we disclose certain
                                information to you about our collection and use of your personal data. Once we receive and verify your request we will disclose to you,
                                depending on the nature of your request, personal data we collected about you, the categories of sources for the data we
                                have collected about you, our business or commercial purposes for collecting or sharing that personal information, the categories
                                of third parties with whom we share that personal information, and the specific pieces of personal information we collected about you.
                                As explained above, we may have disclosed personal data to third parties for a business or commercial purpose. Thus, you have the right
                                to know also personal data that we disclosed about you and the categories of third parties to whom the personal data was disclosed</div>
                        </div>
                        <div>
                        </div>
                    </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <div class="privacy-content">Test</div>
