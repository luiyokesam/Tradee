                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <section class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Today Events</h3>
                                    </div>
                                    <div class="card-body">
                            ...
                            <section class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Delivery Request</h3>
                                    </div>
                                    <div class="card-body">
                                        <table id="refundlisttable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        Customer ID
                            ...
                            <div class="card-body">
                                <div class="tab-content p-0">
                                    ...
                                    <div class="chart tab-pane active" id="sales-chart" style="position: relative; height: 300px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas id="sales-chart-canvas" height="375" style="height: 300px; display: block; width: 879px;" width="1098" class="chartjs-render-monitor"></canvas>
                                    </div>
                                </div>
                            </div> /.card-body 
                        </div>
                    ...
                    <section class="col-lg-5 connectedSortable ui-sortable">
                        ...
                        <div class="card bg-gradient-info">
                            ...
                            <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                <canvas class="chart chartjs-render-monitor" id="line-chart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 879px;" width="1098" height="312"></canvas>
                            </div>
                             /.card-body 
                            <div class="card-footer bg-transparent">
                                <div class="row">
