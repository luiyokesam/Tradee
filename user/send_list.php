...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM delivery d, trade_details t, trade r, customer c WHERE r.tradeid = t.tradeid AND d.tradeid = r.tradeid AND d.tradeid = t.tradeid AND t.custid = c.custid AND d.recipientid = c.custid AND deliveryid = '$id' LIMIT 1";
                ...
                <div class="col-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="cardno" class="form-label">Recipient Name</label>
                                ...
                                <div class="col-md-12 pt-3">
                                    <label for="cardname" class="form-label">Recipient Address</label>
