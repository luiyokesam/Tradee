...
//    $sql = "SELECT * FROM item i, customer c WHERE i.custid = c.custid AND itemid = '$id' LIMIT 1";
    $sql = "SELECT * FROM auction a, auction_details d WHERE a.auctionid = d.auctionid AND itemid = '$id' LIMIT 1";
                    ...
                    <div class="bg-white px-3 py-2 border">
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-lg-12 col-md-5">
                                <div class='py-1'>
                                    <a class="btn btn-block btn-outline-info" data-toggle="modal" data-target="#modal-bid-item">Trade now</a>
                                    <?php
//                                    echo "<a type='button' href='../user/trade_test.php?id=" . $current_data['itemid'] . "' class='btn btn-info btn-block'>Trade now</a>";
                                    ?>
                                </div>
                                <!--<button type="button" class="btn btn-primary" background-color:#48D1CC">Trade now</button>-->
                                <div class='py-1'>
