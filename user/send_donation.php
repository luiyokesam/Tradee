...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM donation_delivery d, donation_details t, event e WHERE d.donationid = t.donationid AND d.eventid = e.eventid AND d.custid = '{$_SESSION['loginuser']['custid']}' AND d.donationid = '$id' LIMIT 1";
...
<html lang="en">
    <head>
        ...
        <title><?php echo $current_data['donationid'] ?> Delivery - Tradee</title>
    </head>
    <body>
                        ...
                        <div class="card card-warning">
                            ...
                            <div class="card-body pb-1">
                                <div class="row pb-2" style="font-weight: bolder;">
                                    <div class="col-xl">
                                        <div class="">Donation ID: <?php echo $current_data['donationid'] ?></div>
                                    </div>

                                    <div class="col-xl">
                                        <div class="">Event ID: <?php echo $current_data['eventid'] ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-12" id="accordion">
                                        <?php
                                        $get_inventory = "SELECT * FROM donation_details d, item i WHERE d.itemid = i.itemid AND d.donator = '{$_SESSION['loginuser']['custid']}' AND d.donationid = '{$current_data['donationid']}'";
                ...
                <div class="col-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="cardno" class="form-label">Donation To</label>
