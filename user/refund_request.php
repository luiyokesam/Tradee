...
<html lang="en">
    <head>
        ...
        <title>Trade T00001 - Refund Request</title>
    </head>
    <body>
        <?php
                            ...
                            <div class="row pt-1 pb-2">
                                <div class="profile-pic-box">
                                    ...
                                    <div class="row align-content-center">
                                        ...
                                        <li class="" style="list-style-type:none; font-size:0.82em;">These are your items to be refund.</li>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="py-2">
                            <div class="row py-2">
                                <div class="profile-pic-box">
                                    ...
                                    <div class="row align-content-center">
                                        <li class="" style="list-style-type:none;">Items selected:</li>
                                        <li class="" style="list-style-type:none; font-size:0.82em;">These are his item to be refund.</li>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="border p-2">
                        ...
                        <div class="py-2">
                            ...
                            <button type="button" class="btn btn-primary float-end ms-1">Accept</button>
                            <button type="button" class="btn btn-warning float-end">Reject</button>
                        </div>
                    </div>
                </div>
            </div>
