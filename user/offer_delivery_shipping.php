                                ...
                                <div class="form-group col-xl p-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12" style="display: none;">
                                            <input type="text" class="form-control" id="recipientid" name="recipientid" readonly="" value="<?php
                                        ...
                                        <div class="col-6" style="display: none;">
                                            <input type="text" class="form-control" id="deliveryaddress1" name="deliveryaddress1" readonly="" value="<?php
                                        ...
                                        <div class="col-6" style="display: none;">
                                            <input type="text" class="form-control" id="deliveryaddress2" name="deliveryaddress2" readonly="" value="<?php
                                        ...
                                        <div class="col-6" style="display: none;">
                                            <input type="text" class="form-control" id="deliverycity" name="deliverycity" readonly="" value="<?php
                                        ...
                                        <div class="col-6" style="display: none;">
                                            <input type="text" class="form-control" id="deliverypostcode" name="deliverypostcode" readonly="" value="<?php
    ...
    <script>
        ...
        function checkout() {
            ...
            if (!document.getElementById("contact").value || document.getElementById("contact").value === "") {
                ...
                if (document.getElementById("contact").value.length < 5 || document.getElementById("contact").value.length > 5) {
                    fulfill = false;
            ...
            if (fullfill) {
                ...
                if (confirm("Confirm your delivery details?")) {
